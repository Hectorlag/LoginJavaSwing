...
public class edicionUsuarios extends javax.swing.JFrame {
    ...
    int id_usuario;//VARIABLE GLOBAL
    controladoraLogica control;//VARIABLE GLOBAL
    Usuario usu;//VARIABLE GLOBAL
    
    public edicionUsuarios(controladoraLogica control,int id_usuario) {//RECIBO COMO PARAMETRO DESDE LA CLASE PRINCIPALADMIN
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        mostrarMensaje("Usuario editado correctamente", "Info", "Edición existosa");
        this.dispose();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //RECORREMOS LA LISTA CONPLETA DE LOS ROLES
        for(int i=0;i<cantidadItems;i++){
            if(String.valueOf(cmbRol.getItemAt(i)).equals(rol)){//LOS CONVERTIMOS A STRING Y COMPARLO CON EL ROL Q TENEMOS
                cmbRol.setSelectedItem(i);                      //SI LO SELECCIONAMOS
